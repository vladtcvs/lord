...
minetest.register_chatcommand("/about", {
	params = "",
	description = SL("Get information about the mod"),
...
minetest.register_chatcommand("/inspect", {
	...
	description = SL("Enable or disable node inspection"),
...
minetest.register_chatcommand("/reset", {
	params = "",
	description = SL("Reset the region so that it is empty"),
	privs = {worldedit=true},
	func = function(name, param)
...
minetest.register_chatcommand("/mark", {
	params = "",
	description = SL("Show markers at the region positions"),
	privs = {worldedit=true},
	func = function(name, param)
		worldedit.mark_pos1(name)
		worldedit.mark_pos2(name)
...
minetest.register_chatcommand("/unmark", {
	params = "",
	description = SL("Hide markers if currently shown"),
	privs = {worldedit=true},
	func = function(name, param)
...
minetest.register_chatcommand("/p", {
	...
	description = SL("Set WorldEdit region, WorldEdit position 1, or WorldEdit position 2 by punching nodes, or display the current WorldEdit region"),
	privs = {worldedit=true},
	func = function(name, param)
...
minetest.register_chatcommand("/fixedpos", {
	...
	description = SL("Set a WorldEdit region position to the position at (<x>, <y>, <z>)"),
	privs = {worldedit=true},
	func = function(name, param)
...
minetest.register_chatcommand("/volume", {
	params = "",
	description = SL("Display the volume of the current WorldEdit region"),
	privs = {worldedit=true},
	func = function(name, param)
		local pos1, pos2 = worldedit.pos1[name], worldedit.pos2[name]
...
minetest.register_chatcommand("/deleteblocks", {
	params = "",
	description = SL("remove all MapBlocks (16x16x16) containing the selected area from the map"),
	privs = {worldedit=true},
...
minetest.register_chatcommand("/set", {
	params = "<node>",
	description = SL("Set the current WorldEdit region to <node>"),
	privs = {worldedit=true},
	func = safe_region(function(name, param)
...
minetest.register_chatcommand("/mix", {
	params = "<node1> ...",
	description = SL("Fill the current WorldEdit region with a random mix of <node1>, ..."),
	privs = {worldedit=true},
	func = safe_region(function(name, param)
		local nodes = {}
...
minetest.register_chatcommand("/replace", {
	...
	description = SL("Replace all instances of <search node> with <replace node> in the current WorldEdit region"),
	privs = {worldedit=true},
	func = safe_region(function(name, param)
...
minetest.register_chatcommand("/replaceinverse", {
	params = "<search node> <replace node>",
	description = SL("Replace all nodes other than <search node> with <replace node> in the current WorldEdit region"),
	privs = {worldedit=true},
	func = safe_region(function(name, param)
		local found, _, search_node, replace_node = param:find("^([^%s]+)%s+(.+)$")
		local norm_search_node = worldedit.normalize_nodename(search_node)
...
minetest.register_chatcommand("/hollowsphere", {
	params = "<radius> <node>",
	description = SL("Add hollow sphere centered at WorldEdit position 1 with radius <radius>, composed of <node>"),
	privs = {worldedit=true},
	func = safe_region(function(name, param)
		local found, _, radius, nodename = param:find("^(%d+)%s+(.+)$")
		local node = get_node(name, nodename)
...
minetest.register_chatcommand("/sphere", {
	params = "<radius> <node>",
	description = SL("Add sphere centered at WorldEdit position 1 with radius <radius>, composed of <node>"),
	privs = {worldedit=true},
	func = safe_region(function(name, param)
		local found, _, radius, nodename = param:find("^(%d+)%s+(.+)$")
		local node = get_node(name, nodename)
...
minetest.register_chatcommand("/hollowdome", {
	params = "<radius> <node>",
	description = SL("Add hollow dome centered at WorldEdit position 1 with radius <radius>, composed of <node>"),
	privs = {worldedit=true},
	func = safe_region(function(name, param)
		local found, _, radius, nodename = param:find("^(%d+)%s+(.+)$")
		local node = get_node(name, nodename)
...
minetest.register_chatcommand("/dome", {
	params = "<radius> <node>",
	description = SL("Add dome centered at WorldEdit position 1 with radius <radius>, composed of <node>"),
	privs = {worldedit=true},
	func = safe_region(function(name, param)
		local found, _, radius, nodename = param:find("^(%d+)%s+(.+)$")
		local node = get_node(name, nodename)
...
minetest.register_chatcommand("/hollowcylinder", {
	...
	description = SL("Add hollow cylinder at WorldEdit position 1 along the x/y/z/? axis with length <length> and radius <radius>, composed of <node>"),
	privs = {worldedit=true},
	func = safe_region(function(name, param)
		local found, _, axis, length, radius, nodename = param:find("^([xyz%?])%s+([+-]?%d+)%s+(%d+)%s+(.+)$")
...
minetest.register_chatcommand("/cylinder", {
	params = "x/y/z/? <length> <radius> <node>",
	description = SL("Add cylinder at WorldEdit position 1 along the x/y/z/? axis with length <length> and radius <radius>, composed of <node>"),
	privs = {worldedit=true},
	func = safe_region(function(name, param)
		local found, _, axis, length, radius, nodename = param:find("^([xyz%?])%s+([+-]?%d+)%s+(%d+)%s+(.+)$")
		length = tonumber(length)
...
minetest.register_chatcommand("/pyramid", {
	...
	description = SL("Add pyramid centered at WorldEdit position 1 along the x/y/z/? axis with height <height>, composed of <node>"),
	privs = {worldedit=true},
	func = safe_region(function(name, param)
...
minetest.register_chatcommand("/spiral", {
	...
	description = SL("Add spiral centered at WorldEdit position 1 with side length <length>, height <height>, space between walls <space>, composed of <node>"),
	privs = {worldedit=true},
	func = safe_region(function(name, param)
...
minetest.register_chatcommand("/copy", {
	params = "x/y/z/? <amount>",
	description = SL("Copy the current WorldEdit region along the x/y/z/? axis by <amount> nodes"),
	privs = {worldedit=true},
	func = safe_region(function(name, param)
...
minetest.register_chatcommand("/move", {
	params = "x/y/z/? <amount>",
	description = SL("Move the current WorldEdit region along the x/y/z/? axis by <amount> nodes"),
	privs = {worldedit=true},
	func = safe_region(function(name, param)
		local pos1, pos2 = worldedit.pos1[name], worldedit.pos2[name]
		local found, _, axis, amount = param:find("^([xyz%?])%s+([+-]?%d+)$")
...
minetest.register_chatcommand("/stack", {
	params = "x/y/z/? <count>",
	description = SL("Stack the current WorldEdit region along the x/y/z/? axis <count> times"),
	privs = {worldedit=true},
	func = safe_region(function(name, param)
...
minetest.register_chatcommand("/stack2", {
	params = "<count> <x> <y> <z>",
	description = SL("Stack the current WorldEdit region <count> times by offset <x>, <y>, <z>"),
	privs = {worldedit=true},
	func = function(name, param)
		local pos1, pos2 = worldedit.pos1[name], worldedit.pos2[name]
		if pos1 == nil or pos2 == nil then
...
minetest.register_chatcommand("/stretch", {
	...
	description = SL("Scale the current WorldEdit positions and region by a factor of <stretchx>, <stretchy>, <stretchz> along the X, Y, and Z axes, repectively, with position 1 as the origin"),
	privs = {worldedit=true},
	func = safe_region(function(name, param)
		local pos1, pos2 = worldedit.pos1[name], worldedit.pos2[name]
...
minetest.register_chatcommand("/transpose", {
	params = "x/y/z/? x/y/z/?",
	description = SL("Transpose the current WorldEdit region along the x/y/z/? and x/y/z/? axes"),
	privs = {worldedit=true},
	func = safe_region(function(name, param)
		local pos1, pos2 = worldedit.pos1[name], worldedit.pos2[name]
...
minetest.register_chatcommand("/flip", {
	params = "x/y/z/?",
	description = SL("Flip the current WorldEdit region along the x/y/z/? axis"),
	privs = {worldedit=true},
	func = safe_region(function(name, param)
...
minetest.register_chatcommand("/rotate", {
	params = "<axis> <angle>",
	description = SL("Rotate the current WorldEdit region around the axis <axis> by angle <angle> (90 degree increment)"),
	privs = {worldedit=true},
	func = safe_region(function(name, param)
		local pos1, pos2 = worldedit.pos1[name], worldedit.pos2[name]
...
minetest.register_chatcommand("/orient", {
	params = "<angle>",
	description = SL("Rotate oriented nodes in the current WorldEdit region around the Y axis by angle <angle> (90 degree increment)"),
	privs = {worldedit=true},
	func = safe_region(function(name, param)
...
minetest.register_chatcommand("/fixlight", {
	params = "",
	description = SL("Fix the lighting in the current WorldEdit region"),
	privs = {worldedit=true},
	func = safe_region(function(name, param)
...
minetest.register_chatcommand("/hide", {
	params = "",
	description = SL("Hide all nodes in the current WorldEdit region non-destructively"),
	privs = {worldedit=true},
	func = safe_region(function(name, param)
...
minetest.register_chatcommand("/suppress", {
	params = "<node>",
	description = SL("Suppress all <node> in the current WorldEdit region non-destructively"),
	privs = {worldedit=true},
	func = safe_region(function(name, param)
		local node = get_node(name, param)
...
minetest.register_chatcommand("/highlight", {
	params = "<node>",
	description = SL("Highlight <node> in the current WorldEdit region by hiding everything else non-destructively"),
	privs = {worldedit=true},
	func = safe_region(function(name, param)
		local node = get_node(name, param)
...
minetest.register_chatcommand("/restore", {
	params = "",
	description = SL("Restores nodes hidden with WorldEdit in the current WorldEdit region"),
	privs = {worldedit=true},
	func = safe_region(function(name, param)
...
minetest.register_chatcommand("/save", {
	params = "<file>",
	description = SL("Save the current WorldEdit region to \"(world folder)/schems/<file>.we\""),
	privs = {worldedit=true},
	func = safe_region(function(name, param)
		if param == "" then
			worldedit.player_notify(name, "invalid usage: " .. param)
...
minetest.register_chatcommand("/allocate", {
	params = "<file>",
	description = SL("Set the region defined by nodes from \"(world folder)/schems/<file>.we\" as the current WorldEdit region"),
	privs = {worldedit=true},
	func = function(name, param)
...
minetest.register_chatcommand("/load", {
	params = "<file>",
	description = SL("Load nodes from \"(world folder)/schems/<file>[.we[m]]\" with position 1 of the current WorldEdit region as the origin"),
	privs = {worldedit=true},
	func = function(name, param)
		local pos = get_position(name)
		if pos == nil then return end
...
minetest.register_chatcommand("/lua", {
	params = "<code>",
	description = SL("Executes <code> as a Lua chunk in the global namespace"),
...
minetest.register_chatcommand("/luatransform", {
	params = "<code>",
	description = SL("Executes <code> as a Lua chunk in the global namespace with the variable pos available, for each node in the current WorldEdit region"),
	privs = {worldedit=true, server=true},
	func = safe_region(function(name, param)
		local admin = minetest.setting_get("name")
		if not admin or not name == admin then
...
minetest.register_chatcommand("/mtschemcreate", {
	params = "<file>",
	description = SL("Save the current WorldEdit region using the Minetest Schematic format to \"(world folder)/schems/<filename>.mts\""),
	privs = {worldedit=true},
	func = safe_region(function(name, param)
		if param == nil then
...
minetest.register_chatcommand("/mtschemplace", {
	params = "<file>",
	description = SL("Load nodes from \"(world folder)/schems/<file>.mts\" with position 1 of the current WorldEdit region as the origin"),
	privs = {worldedit=true},
	func = function(name, param)
		if param == nil then
			worldedit.player_notify(name, "no filename specified")
...
minetest.register_chatcommand("/mtschemprob", {
	...
	description = SL("Begins node probability entry for Minetest schematics, gets the nodes that have probabilities set, or ends node probability entry"),
	privs = {worldedit=true},
	func = function(name, param)
...
minetest.register_chatcommand("/clearobjects", {
	params = "",
	description = SL("Clears all objects within the WorldEdit region"),
	privs = {worldedit=true},
	func = safe_region(function(name, param)
