...
dofile(minetest.get_modpath("lottmobs").."/boar.lua")
...
mobs:register_mob("lottmobs:battle_troll", {
	...
	drops = {
		...
		{name = "lottmobs:meat_raw",							chance = 5,		min = 1,		max = 5,},
