...
lottmobs.dwarf = {
	items = {
		...
		{"lottores:silversword 1",			"lord_money:silver_coin 7",		10},
		...
		{"lottweapons:mithril_dagger 1",	"lord_money:silver_coin 15",	20},
		{"lottores:mithrilsword 1",			"lord_money:silver_coin 35",	30},
		{"default:sword_steel 1",			"lord_money:silver_coin 5",		10},
		{"lottweapons:silver_battleaxe 1",	"lord_money:silver_coin 10",	18},
	...
	items_race = {
		...
		{"lottores:silversword 1",			"lord_money:silver_coin 5",		10},
		{"default:bronze_ingot 25",			"lord_money:silver_coin 4",		15},
		{"lottblocks:small_lamp_pine 6",	"lord_money:silver_coin 2",		6},
		{"lottblocks:dwarf_harp 1",			"lord_money:silver_coin 12",	10},
		{"lottweapons:mithril_dagger 1",	"lord_money:silver_coin 14",	20},
		{"lottores:mithrilsword 1",			"lord_money:silver_coin 32",	30},
		{"default:sword_steel 1",			"lord_money:silver_coin 4",		10},
		{"lottweapons:silver_battleaxe 1",	"lord_money:silver_coin 9",		18},
...
lottmobs.elf = {
	...
	items_race = {
		...
		{"lottweapons:galvorn_spear 1",		"lord_money:silver_coin 22",	20},
		{"lottweapons:silver_battleaxe 1",	"lord_money:silver_coin 15",	14},
		{"lottores:galvornsword 1",			"lord_money:silver_coin 21",	25},
		{"lottplants:elanor 10",			"lord_money:silver_coin 2",		22},
...
lottmobs.hobbit = {
	items = {
		...
		{"lottfarming:corn0 12",		"lord_money:silver_coin 30",	25},
		{"farming:hoe_bronze 1",			"lord_money:silver_coin 25",	25},
		{"lottinventory:brewing_book 1",	"lord_money:silver_coin 35",	25},
		{"lottfarming:barley0 "..math.random(5,10),	"lord_money:silver_coin 3",	14},
	...
	items_race = {
		...
		{"lottfarming:corn0 12",		"lord_money:silver_coin 27",	25},
